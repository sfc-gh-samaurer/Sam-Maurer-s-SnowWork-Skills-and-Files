...
**Folder path:** SnowWork → Accounts → {AccountName} → Data Lineage
...
- Check for `Data Lineage` under `{AccountName}`
...
./node /Users/michaelkelly/CoCo/Scripts/upload_to_gsheets.mjs \
  "/path/to/<Customer>_Ingestion_to_Consumption.xlsx" "<Customer> Ingestion to Consumption" "DATA_LINEAGE_FOLDER_ID"
```
