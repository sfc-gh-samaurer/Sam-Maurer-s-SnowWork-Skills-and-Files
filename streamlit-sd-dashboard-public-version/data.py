...
def load_capacity_renewals():
    ...
    df = session.sql(_sql("""
        ...
        a360 AS (
            SELECT
                SALESFORCE_ACCOUNT_ID,
                CAST(OVERAGE_UNDERAGE_PREDICTION AS FLOAT) AS OVERAGE_UNDERAGE_PREDICTION,
                DAY_OF_OVERAGE,
                DAYS_TILL_OVERAGE
        ...
        SELECT
            ...
            COALESCE(a360.OVERAGE_UNDERAGE_PREDICTION, b.OVERAGE_UNDERAGE_AMOUNT_C) AS OVERAGE_UNDERAGE_PREDICTION,
            COALESCE(a360.DAY_OF_OVERAGE, b.OVERAGE_DATE_C) AS OVERAGE_DATE,
        ...
        FROM base b
        LEFT JOIN a360 ON b.SALESFORCE_ACCOUNT_ID = a360.SALESFORCE_ACCOUNT_ID
