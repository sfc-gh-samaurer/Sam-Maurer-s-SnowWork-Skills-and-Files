...
if not df.empty:
    ...
    if not candidates.empty:
        with st.expander(f":material/swap_horiz: **Capacity Conversion Candidates** — {len(candidates)} accounts ending within 24mo with predicted underburn", expanded=True):
