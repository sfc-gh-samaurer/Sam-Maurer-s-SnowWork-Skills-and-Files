...
def load_capacity_renewals():
    ...
    df = session.sql(_sql("""
        ...
        SELECT
            ...
            COALESCE(dc.CAPACITY_USED, b.ACTUAL_CONSUMPTION_YTD_C) AS CAPACITY_USED,
            COALESCE(dc.CAPACITY_REMAINING, b.CURRENT_CAPACITY_VALUE_C - b.ACTUAL_CONSUMPTION_YTD_C) AS CAPACITY_REMAINING,
