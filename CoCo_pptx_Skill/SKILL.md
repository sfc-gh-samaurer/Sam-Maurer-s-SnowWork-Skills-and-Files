---
name: pptx
description: "Create Snowflake-branded PowerPoint decks (.pptx) with Google Drive sync. Use for any task requiring presentation creation, slide generation, .pptx file output, or Google Slides delivery. Saves to Google Drive Desktop by default for instant Google Slides access."
allowed-tools: Bash, Read, Write
log_marker: SKILL_USED_RENDER_PPTX
skill_version: "2026-02-15"
---
...
add_shape_text(slide, "Section A\n• Bullet 1\n• Bullet 2", 0.5, 1.5, 2.8, 2.5, ...)
add_shape_text(slide, "Section B\n• Bullet 1\n• Bullet 2", 3.5, 1.5, 2.8, 2.5, ...)
add_shape_text(slide, "Section C\n• Bullet 1\n• Bullet 2", 6.5, 1.5, 2.8, 2.5, ...)
